...
//下記を追加
class MyClipper extends CustomClipper<Path> {//台形内容
  @override
  getClip(Size size) {
     var path = Path();
...
class MyClipper2 extends CustomClipper<Path> {//三角形内容
  @override
  getClip(Size size) {
      var path = Path();
...
//LankViewPage
class LankViewPage extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
        TextButton(//ホームに戻るボタン
        onPressed: (){
      Navigator.pop(context);},
       child: Text('Home', style: TextStyle(fontSize: 40, color: Colors.blue),),
       ),
        TextButton(//ランク1に戻るボタン
        onPressed: (){
      },
       child: Text('Rank 1', style: TextStyle(fontSize: 40, color: Colors.blue),),
       ),
        Padding(
                 ...
                 SizedBox(height: 5, width: 40),
                  ...
                  Flexible(
                    ...
                    child: Column(
                       mainAxisAlignment: MainAxisAlignment.center,
                       children: [
                        Text('Rank5', style: TextStyle(fontSize: 20),),
                        SizedBox(height: 41),

                        Text('Rank4', style: TextStyle(fontSize: 20),),
                        SizedBox(height: 41),

                        Text('Rank3', style: TextStyle(fontSize: 20),),
                        SizedBox(height: 41),

                        Text('Rank2', style: TextStyle(fontSize: 20),),
                        SizedBox(height: 41),
                        
                        Text('Rank1', style: TextStyle(fontSize: 20),),
                       ],
                      ),
                     ),
											   SizedBox(height: 20),    
